...
const activitySchema = new mongoose.Schema(
  {
    ...
    role: { 
      type: String, 
      default: "Unknown",
      index: true, // 🔥 ADDED: Fixes slow group/filter by role
    },
    ...
    prediction_label: {
      ...
      enum: ["Normal", "Anomaly"],
      default: "Normal",
      index: true, // 🔥 ADDED: Fixes slow anomaly filtering
    },
    ...
    status: {
      ...
      default: "open",
      index: true, // 🔥 ADDED: Fixes slow status/resolution filtering
    },
    ...
    severity: {
      ...
      default: "Low",
      index: true, // 🔥 ADDED: Fixes slow critical/high alert counting
    },
    ...
    createdAt: {
      ...
      index: true,               // 🔥 ADDED: Crucial for time-based filtering
    },
